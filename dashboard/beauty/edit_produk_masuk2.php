...
$kategori='';
    ...
    if(isset($_POST['submit'])){
        ...
        $id=$_GET['id'];
        $query = "UPDATE produk_beauty_masuk SET kode_produk=?, nama_produk=?, jumlah_masuk=?, kategori=?, satuan=?, tanggal_masuk=? WHERE id_masuk=?";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form method="POST">
                    ...
                    <?php	
                        $id=$_GET['id'];
						$ret="SELECT * from produk_beauty_masuk where id_masuk=?";
