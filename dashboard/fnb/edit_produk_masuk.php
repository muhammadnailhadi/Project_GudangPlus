...
$kategori='';
    ...
    if(isset($_POST['submit'])){
        ...
        $id=$_GET['id'];
        $query = "UPDATE produk_fb_masuk SET kode_produk=?, nama_produk=?, jumlah_masuk=?, kategori=?, satuan=?, tanggal_masuk=? WHERE id_masuk=?";
        $stmt = $koneksi->prepare($query);
        $rc = $stmt->bind_param('sssssss', $kode, $nama, $jumlah, $kategori, $satuan, $tanggal_masuk, $id);        
        $stmt->execute();
        echo "<script>alert('Data berhasil diupdate');</script>";
        echo "<script>window.location.href='manage_produk_masuk.php';</script>";
        }
        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Update Produk Masuk</h4>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="jumlah"value="<?php echo $row->jumlah_masuk;?>" id="jumlah" class="form-control" placeholder="Enter Quantity" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="date" name="tanggal_masuk"value="<?php echo $row->tanggal_masuk;?>" id="tanggal_masuk" class="form-control" placeholder="Enter Entry Date" required>
                                    </div>
                                </div>
                            </div>
                        </div>
