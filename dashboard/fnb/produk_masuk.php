<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $getLastIdQuery = "SELECT id_masuk FROM produk_fb_masuk ORDER BY id_masuk DESC LIMIT 1";
        ...
        $query = "INSERT INTO produk_fb_masuk (id_masuk, kode_produk, nama_produk, jumlah_masuk, kategori, satuan, tanggal_masuk) VALUES (?, ?, ?, ?, ?, ?, ?)";
