...
<body>
                ...
                <div class="card-group">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><?php include 'counters/hitung.php'?></h2>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><?php include 'counters/hitung2.php'?></h2>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><?php include 'counters/hitung3.php'?></h2>
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Bahan Baku</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 font-weight-medium"><?php include 'counters/hitung4.php'?></h2>
    ...
    <?php
        include('../includes/koneksi.php');
        $sql = "SELECT nama_produk, kuantitas FROM produk";
...
<?php
include('../includes/koneksi.php');
$sql = "SELECT kategori, SUM(kuantitas) AS total_kuantitas FROM produk GROUP BY kategori";
$result = $koneksi->query($sql);
