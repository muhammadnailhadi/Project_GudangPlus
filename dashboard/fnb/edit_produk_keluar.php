...
$kategori='';
    ...
    if(isset($_POST['submit'])){
        ...
        $id=$_GET['id'];
        $query = "UPDATE produk_fb_keluar SET kode_produk=?, nama_produk=?, jumlah_keluar=?, kategori=?, satuan=?, tanggal_keluar=? WHERE id_keluar=?";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form method="POST">
                    ...
                    <?php	
                        $id=$_GET['id'];
						$ret="SELECT * from produk_fb_keluar where id_keluar=?";
