<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $getLastIdQuery = "SELECT id_keluar FROM produk_fb_keluar ORDER BY id_keluar DESC LIMIT 1";
        ...
        $query = "INSERT INTO produk_fb_keluar (id_keluar, kode_produk, nama_produk, jumlah_keluar, kategori, satuan, tanggal_keluar) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    echo "<script>window.location.href='manage_produk_keluar.php';</script>";    
    }
?>
